              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="" method="POST">
                    ...
                    <!--<div class="form-group">
                      <input type="password" class="form-control form-control-user" name="re_password" id="exampleInputRePassword" placeholder="Repeat Password">
                    </div>-->
                    <div class="form-group">
                    ...
                    if (isset($_POST['login'])) {
                     ...
                     // $hassedPass = sha1($re_password);
                      ...
                      while ($row = mysqli_fetch_array($auth_user)) {
                        ...
                        if ($email == $_SESSION['user_email'] && $hassedPass == $password && $_SESSION['is_active'] == 1) 
                        {
                        ...
                        // if ($email == $_SESSION['user_email'] && $hassedPass == $re_password) 
                        // {
                        //   header("Location: dashboard.php");
                        // }
                        // else if($email!=$_SESSION['user_email'] || $hassedPass != $re_password)
                        // {
                        //   header("Location: index.php");
                        // }
                        else
