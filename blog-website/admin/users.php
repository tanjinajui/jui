                ...
                <td>
                  <?php 
                    if ($user_role == 0) {
                      ...
                      echo '<span class = "badge badge-primary">Users</span>';
                    }
                    else{
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                          ...
                          if (empty($formErrors)) {
                            ...
                            if (!$add_user) {
                              ...
                              $query = "INSERT INTO users (name, username, password, user_email, user_phone, user_address, user_role, join_date) VALUES ('$name', '$username', '$hassedPass', '$email', '$phone', '$user_address', '$user_role', now())";
                            $add_user = mysqli_query($connect,$query);
                            if (!$add_user) {
                              die("Query Failed!" . mysqli_error($connect));;
                            }
                              ...
                              <div class="form-group">
                                <label for = "user_role">User Role</label>
                                  <select class="form-control" name="user_role">
                                    ...
                                    <option value="2" <?php if ($user_role == 2){echo 'selected';}?>>Users</option>
                                  </select>
                              </div>
                              <!-- User Status Field-->
                              <div class="form-group">
