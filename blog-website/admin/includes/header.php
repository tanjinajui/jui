      ...
      <li class="nav-item">
        ...
        <div id="posts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="all-posts.php">All Blog Posts</a>
            <a class="collapse-item" href="add-post.php">Add New Post</a>
          </div>
        </div>
      </li>

      <!-- Nav Item - Comment Menu -->
      <li class="nav-item">
        ...
        <div id="comment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="all-comments.php">All Blog Comments</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                {?>
                  <img class="img-profile rounded-circle" src="img/users_avater/<?php echo $_SESSION['user_avater']; ?>">
               <?php }
                else
                {?>
                  <img class="img-profile rounded-circle" src="img/users_avater/default.png">
               <?php }
                ?>
