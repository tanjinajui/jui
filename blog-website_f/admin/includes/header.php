...
<head>
  ...
  <title>Blog Website - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">Blog Website</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="all-categories.php">All Categories</a>
          </div>
        </div>
      </li>

      <!-- Nav Item - Blog Post Menu -->
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="comment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">All Blog Comments:</h6>
            <a class="collapse-item" href="allcomments.php">All Comments</a>
            <a class="collapse-item" href="">Add New Comment</a>
          </div>
        </div>
      </li>
        ...
        { ?>
          ...
          <li class="nav-item">
            ...
            <div id="setting" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Web Site Settings:</h6>
          ...
          <li class="nav-item">
            ...
            <div id="subscriber" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="subscriber.php">Subscriber List</a>
              </div>
            </div>
          </li>
        <?php }   ?>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                  ...
                  { ?>
                    <img class="img-profile rounded-circle" src="img/users-avater/<?php echo $_SESSION['avater']; ?>">
                  <?php }
                  else
                    { ?>
                      <img class="img-profile rounded-circle" src="img/users-avater/default.png">
                    <?php }
                ?>
